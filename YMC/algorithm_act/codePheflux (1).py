...
def Pheflux(inputFileName, processDir):
    ...
    for i in range(nRows):
        ...
        k            = inputData.loc[i]["KnownUptakes"]
        ...
        #k = 1000
        fluxes,optimization_time,total_time,status,success,lbx,ubx = optPheFlux(model,fpkmDic,float(k),init_time)
