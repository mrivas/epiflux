...
#################################################################################
### OPTIMIZATION
def optEpiFlux(model,fpkmDic,k,fluxesDic,init_time,vo2Known):
    ##############################################################
    ...
    return(EpiFlux_fluxes,optimization_time,total_time,status,success, lbx, ubx)
...
def getFluxes(inputFileName, processDir):
    ...
    for i in range(nRows):
        ...
        fluxes,optimization_time,total_time,status,success,lbx,ubx = optEpiFlux(model,fpkmDic,k,fluxesDic,init_time,vo2Known)
